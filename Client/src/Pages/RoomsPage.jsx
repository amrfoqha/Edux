...
const RoomsPage = () => {
  ...
  return (
    <div>
      <div className="min-h-screen bg-linear-to-br from-background via-muted/30 to-background py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-10">
          <ChatHeader
            room={true}
            subText={"Join study groups and collaborate with fellow students"}
            text={"Chat Rooms"}
            routeText={"Create Room"}
            route={"/add-room"}
