    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <img
            src={
              "https://images.unsplash.com/photo-1764079833254-a14555e35d9e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
            }
            alt="Our Mission"
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              We believe that education should be accessible to everyone. EDUx
              was founded by students, for students, with a vision to create a
              collaborative learning environment where knowledge flows freely
              and everyone has the opportunity to excel.
            </p>
      ...
      <section className="py-24 bg-gray-50 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4">Why Choose EDUx?</h2>
      ...
      <section className="py-24 bg-white text-center">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <Value
              title="Innovation"
              desc="Constantly evolving our platform with cutting-edge technology to enhance learning experiences."
            />
            <Value
              title="Community"
              desc="Building a supportive academic community where everyone helps each other succeed."
            />
            <Value
              title="Excellence"
              desc="Maintaining the highest standards of quality in every resource shared on our platform."
            />
            <Value
              title="Growth"
              desc="Encouraging continuous personal and academic growth for each student."
            />
          </div>
        </div>
      </section>
